...
int main() {
    ...
    up_menu_EintragHinzufuegen(sortiermenu, "#Anmerkung: Um absteigend zu sortieren, ein \"-\" vor die Eingabe stellen", "#", sortiermenu, NULL);
    //Bearbeitungsmenu
    t_menu *bearbeitungsmenu = up_menu_erzeugeUnterMenu(datensatzMenu, "Datensatz bearbeiten");
    up_menu_EintragHinzufuegen(bearbeitungsmenu, "Datensatz hinzufuegen", "a", bearbeitungsmenu, NULL);
